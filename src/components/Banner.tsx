...
const Banner = () => {
  ...
  <span className="color-gradient-text" >Development Stack</span></h1>
        ...
        <div className="mt-8 flex w-full items-center justify-center md:justify-start gap-3 font-serif">
          <button className="px-6 py-3 rounded-xl color-gradient-bg">
            Explore Technologies
          </button>
          <button className="bg-white text-gray-600 border-2 border-gray-100 py-3 px-10 rounded-2xl">Learn More</button>
        </div>
      </div>
